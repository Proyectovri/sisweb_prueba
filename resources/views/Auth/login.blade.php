                ...
                <div class="row justify-content-center mt-7 mt-sm-0">
                    <div class="col-lg-9 col-xl-8">
                                ...
                                <div class="card-body page-single-content">
                                    <div class="w-100">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Ingrese su correo">
                                            @error('email')
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Ingrese su contraseña">
                                            @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        ...
                                        <a href="forgot-password-1.html" class="btn btn-link box-shadow-0 px-0">Forgot password?</a>
                                            ...
                                            <div class="col-12">
                                                <div class="text-center pt-1 mb-5 pb-1">
                                                    <button type="submit" class="btn btn-lg btn-primary btn-block" type="button"><i class="fe fe-arrow-right"></i>Iniciar Sesion</button>
                                                </div>                                            
                                            </div>
                                        </div>
                                        <div class="pt-4">
                                    <div class="font-weight-normal fs-16">No tienes una cuenta? <a class="btn-link font-weight-normal" href="{{ route('registrar')}}">Registrate Aqui</a></div>
                                </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="text-center pt-4">
                            <div class="font-weight-normal fs-16">Vicerectorado de Investigacion © 2023</div>
                        </div>
                    </div>
                </div>
            </div>
