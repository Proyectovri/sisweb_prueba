                                ...
                                <div class="card-body page-single-content">
                                    <div class="w-100">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="email" name="Usua_Correo" class="form-control @error('email') is-invalid @enderror" placeholder="Ingrese su correo">
                                            @error('email')
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="password" name="Usua_Clave" class="form-control @error('password') is-invalid @enderror" placeholder="Ingrese su contraseña">
                                            @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <a href="{{ route('registrar') }}" class="">No tienes Cuenta? Registrate</a>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
