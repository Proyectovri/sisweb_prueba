            ...
            <div class="row justify-content-center mt-7 mt-sm-0">
                {{-- <div class="col-lg-9 col-xl-8">
                    <div class="card-group mb-0">
                        <div class="card text-white bg-primary py-5 d-none d-lg-block page-content mt-10">
                        ...
                        <div class="card p-4 page-content">
                            <div class="card-body page-single-content">
                                <div class="w-100">
                                    ...
                                    <p class="text-muted">Ingresa tu correo institucional para enviar un código de inicio de sesión</p>
                                        </div>
                                        <hr class="my-5">
