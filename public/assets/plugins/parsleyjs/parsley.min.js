...
!(function (e, t) {
                ...
                for (s = e.attributes, n = s.length; n--; )
                    (r = s[n]),
                        r &&
                            r.specified &&
                            a.test(r.name) &&
                            (i[this.camelize(r.name.slice(t.length))] =
    ...
    p.prototype = {
        ...
        removeValidator: function (e) {
            return (
                this.validators[e] ||
                    a.warn('Validator "' + e + '" is not defined.'),
    ...
    w.prototype = {
        onSubmitValidate: function (e) {
            ...
            if (!0 !== e.parsley) {
                var i =
                    this._submitSource ||
                    this.$element.find(a._SubmitSelector)[0];
                if (
    ...
    P.prototype = {
        ...
        handleMultiple: function () {
            ...
            for (var r = this._findRelated(), s = 0; s < r.length; s++)
                if (
                    ((i = e(r.get(s)).data("Parsley")), "undefined" != typeof i)
                ) {
    ...
    _extends(x.prototype, y.Field, l.prototype),
        ...
        "undefined" == typeof window.ParsleyExtend &&
            (window.ParsleyExtend = {}),
